...
# Funktion zum Berechnen der ROUGE Scores zwischen einer Referenzantwort und Modellantwort
def calculate_rouge(reference, model_answer):
    rouge = evaluate.load("rouge", module_type="metric")
    
    # Berechnung der ROUGE-Scores
    results = rouge.compute(predictions=[model_answer], references=[reference])

    # Direkter Zugriff auf die ROUGE-Scores
    rouge_1_f1 = results["rouge1"]
    rouge_2_f1 = results["rouge2"]
    rouge_L_f1 = results["rougeL"]
    rouge_Lsum_f1 = results["rougeLsum"]
    
    # Ausgabe der Ergebnisse
    print(f"ROUGE-1 F1-Score: {rouge_1_f1}")
    print(f"ROUGE-2 F1-Score: {rouge_2_f1}")
    print(f"ROUGE-L F1-Score: {rouge_L_f1}")
    print(f"ROUGE-Lsum F1-Score: {rouge_Lsum_f1}")
    
    return rouge_1_f1, rouge_2_f1, rouge_L_f1, rouge_Lsum_f1
...
# Berechnung der ROUGE-Scores für alle Modellantworten
print("Ergebnisse Llama:")
calculate_rouge(reference_answer_11, answer_llama_11)

print("\nErgebnisse Gemma:")
calculate_rouge(reference_answer_11, answer_gemma_11)

print("\nErgebnisse Mistral:")
calculate_rouge(reference_answer_11, answer_mistral_11)
