...
from langchain.text_splitter import RecursiveCharacterTextSplitter #TODO in VectorMetaData if vector db has to big entries
...
if __name__ == "__main__":
    ...
    res = db.similarity_search("I feel good")
